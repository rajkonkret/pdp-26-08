# set (zbiór) - przechowuje unikalne elementy (wartości)
...
print(id(zbior_copy))  # 2556876803872
print(id(zbior))  # 2556876808352
...
# {777, 11, 44, 18, 22, 24} - {999, 11, 44, 12.34, 18, 52, 667, 62} = {777, 22, 24}
